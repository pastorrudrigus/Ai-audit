...
CREATE INDEX IF NOT EXISTS "request_logs_org_id_created_at_idx" ON "request_logs" ("org_id","created_at");-- Attachments — anexos PDF/DOCX/TXT enviados pelo advogado no chat.
